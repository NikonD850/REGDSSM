...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self.father_train_path='/mnt/afs/users/fandawei/data/event-deblur/GOPRO_AHDINet/train'
        self.father_val_path='/mnt/afs/users/fandawei/data/event-deblur/GOPRO_AHDINet/test'
        self.father_test_path='/mnt/afs/users/fandawei/data/event-deblur/GOPRO_AHDINet/test'
